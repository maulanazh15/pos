...
@section('content')
	...
	<div>
		...
		<h1 class="page-header mb-0">Penjualan</h1>
	</div>
	<!-- END breadcrumb -->
	<!-- BEGIN row -->
	<div class="row">
		...
		<div class="col-xl-100%">
			<div class="panel panel-inverse">
				...
				<div class="panel-heading">
					<h4 class="panel-title">Tabel Penjualan</h4>
				</div>
				<!-- END panel-heading -->
				<!-- BEGIN panel-body -->	
					...
					<table id="data-table-combine" class="table table-striped table-bordered align-middle">
						<thead>
							<tr>
								...
								<th class="text-nowrap" width="7%">Tanggal</th>
								<th class="text-nowrap" width="15%">Nama Menu</th>
								<th class="text-nowrap" width="10%">Kode Menu</th>
								<th class="text-nowrap" width="10%">Harga</th>
								<th class="text-nowrap" width="10%">Terjual</th>
								<th class="text-nowrap" width="10%">Total</th>
